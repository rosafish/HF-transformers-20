...
python ../run_glue.py \
	...
	--task_name ESNLI \
	--do_eval \
	--dev_data_path /data/rosa/HF-transformers-20/examples/EncoderDecoderModel/esnli/save_best_models/bert_hans_seed${seed}_train${training_size}_${quality}/matched_test_text_esnli_format.csv \
	--max_seq_length 128 \
