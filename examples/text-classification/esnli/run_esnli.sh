...
python ../run_glue.py \
	...
	--dev_data_path ../../EncoderDecoderModel/esnli/save_best_models/${bert2bert_pretrained_model}_hans_seed${seed}_train${training_size}_${quality}/dev_text_esnli_format.csv \
	--test_data_path ../../EncoderDecoderModel/esnli/save_best_models/${bert2bert_pretrained_model}_hans_seed${seed}_train${training_size}_${quality}/${test_type}_test_text_esnli_format.csv \
	--max_seq_length 128 \
