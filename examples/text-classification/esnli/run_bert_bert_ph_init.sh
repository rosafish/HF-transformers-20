...
if [ $server = ego ]; then
    ...
    model_path_prefix=./save_best_model/${data_dir_name}_etp_train_${train}_dev_${validation}_ph_init/
    ...
    model_path_prefix=/net/scratch/zhouy1/randomness_experiment/${data_dir_name}/seqclas_train_${train}_dev_${validation}_ph_init/

fi

model_dir=/net/scratch/zhouy1/randomness_experiment/${data_dir_name}/seqclas_train_${train}_dev_${validation}/${seqclas_pretrained_model}_hans_seed${seed}_partition${partition}_train${training_size}_${quality}_datafrom${seqclas_pretrained_model}/best_model
