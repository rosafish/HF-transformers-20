...
def main():
    ...
    if config.finetuning_task != data_args.task_name:
        ...
        logging.info('******* Updated model config: ', str(config))
    ...
    if training_args.do_train:
        ...
        if not training_args.save_best_model:
    ...
    if training_args.do_eval and not training_args.save_best_model:
        ...
        for eval_dataset in eval_datasets:
            ...
            eval_result = trainer.evaluate(eval_dataset=eval_dataset, tokenizer=tokenizer)
